      ...
      <div className="flex basis-full w-full flex-col items-center h-full  ">
        <div className=" font-medium    w-full flex items-center justify-center">
          <form
            ...
            className="flex flex-col text-[#4B5B65] self-center  w-full xl:w-8/12   font-euclid items-center "
          >
            <div className="flex   w-full  flex-col gap-2 xl:gap-6">
              ...
              <Select>
                <SelectTrigger className="  font-medium  text-start h-14 w-full px-8   border  shadow-none">
                  <SelectValue
                    className="text-xl"
                    placeholder="Category of Engineer"
                  />
                </SelectTrigger>
              ...
              <div className="w-full py-4 flex  items-center justify-between">
                ...
                <div className="flex items-center gap-1.5">
                  <p className="  text-[#4B5B65] font-medium">
                    Forgot Password
                  </p>
                </div>
              </div>
            ...
            <div className="w-full py-10  flex items-center justify-center gap-5">
            ...
            <div className="w-full  flex items-center justify-center gap-16">
              <div className="flex  font-medium h-16 w-[195px] gap-2 items-center justify-center border-2 border-[#386A8B] rounded-md text-[#4B5B65]">
            ...
            <div className=" w-full text-[#4B5B65] items-center  mt-8 justify-center gap-4 flex  font-semibold">
